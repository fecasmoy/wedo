    ...
    ApplicationContextAware
{
    ...
    private static final Log logger =
        LogFactory.getLog(BeanInvokingJobDetailFactoryBean.class);
     ...
     * 
     * @param jobListenerNames job listener name
     * @see #jobListenerNames
     */
     ...
     * 
     * @param shouldRecover should recover
     * @see #shouldRecover
     */
        ...
        implements Job
    {
         ...
         * 记录日志的时候用到的日志工具类
         */
        private static final Log log = LogFactory.getLog(BeanInvokingJob.class);
            ...
            throws JobExecutionException
        {
            try
            {
                ...
                String targetBean =
                    context.getMergedJobDataMap().getString("targetBean");
                ...
                Object argumentsObject =
                    context.getMergedJobDataMap().get("arguments");
                Object[] arguments =
                    (argumentsObject instanceof String) ? null
                        : (Object[]) argumentsObject;
                log.debug("arguments array is " + Arrays.toString(arguments));
                
                Object bean = applicationContext.getBean(targetBean);
                log.debug("applicationContext resolved bean name/id '"
                    + targetBean + "' to " + bean);
                ...
                beanMethod.prepare();
                log.info("Invoking Bean: " + targetBean + "; Method: "
